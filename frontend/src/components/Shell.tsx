            ...
            {inboxCount > 0 && (
              <span
                style={{
                  ...
                  backgroundColor: currentRole === 'technician' ? 'var(--bg)' : 'var(--primary)',
                  color: currentRole === 'technician' ? 'var(--primary)' : 'var(--bg)',
                  lineHeight: 1,
                  boxShadow: '0 0 6px rgba(0, 255, 178, 0.3)',
                }}
              >
                {inboxCount}
              </span>
